...
export default function FilterBarLayoutTwo() {
  ...
  const { openSidebar, setSidebarView, stickyMobileFilter } = useUI();
  ...
  return (
    <div
      className={cn(
        "top-14 md:top-16 lg:top-22 h-14 md:h-16 z-10 flex xl:hidden items-center justify-between py-3 px-5 lg:px-7 bg-light border-t border-b border-border-200",
        {
          sticky: !stickyMobileFilter,
          "fixed w-full": stickyMobileFilter,
        }
      )}
    >
      <button
